...
* Layers can be hidden or displayed by clicking on layers contained in the map layer icon
  ...
  * The default metric for the US/CA Census layers are Total Population and Population(2016), respectively
...
* The right sidebar contains inputs the user can use to augment the map 
  ...
  * The user can change the census layer coloring be changed by interacting with the Census Filters menu
